...
<link rel="stylesheet" href="New_css/jquery.slideBox.css"
	type="text/css"></link>
</head>
				...
				$(document)
						.ready(
								function() {
									...
									$("#tpcbanner_list a:not(:first-child)")
											.hide();

									$("#tpbanner_list a:not(:first-child)")
											.hide();
					...
					<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="194" height="60"><img
										src="New_images/index_04.png" width="134" height="48" /></td>
									<td width="130" height="60" align="center"><a
										href="news.aspx-type=jqdt&s_sort=58.htm"> <img
											src="New_images/index_06.png" width="53" height="19" /> </a></td>
								</tr>
								<tr>
										...
										<div id="tpcbanner">
											...
											<div id="tpcbanner_list">
												<a href="#" target="_blank">
													<img src="New_images/indexl_010.gif" width="269px"
													height="177px" title="仙台山！" alt="仙台山" /> </a> <a
													href="#" target="_blank">
													<img src="New_images/indexl_010.gif" width="269px"
													height="177px" title="仙台山！" alt="仙台山！" /> </a>
											</div>
										</div>
									</td>
								</tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="330" height="60"><img
										src="New_images/index_03.png" width="134" height="48" /></td>
						...
						<td width="262" height="260" align="right"><img
							...
							usemap="#Map" /> <map name="Map" id="Map">
								<area shape="rect" coords="21,25,129,56" href="jiemian.jsp"
									target="_blank" />
							</map>
						</td>
					</tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="170" rowspan="2" align="center" class="di"><img
										src="New_images/indexl_009.gif" alt="" width="122" height="83" />
									</td>
									<td height="174" class="dcjj">
										<p class="fontcss">&nbsp;&nbsp;&nbsp; ${_jianjie }</p>
									</td>
								</tr>
								<tr>
									<td height="49" align="right"><a href="about.jsp"
										class="fontcss">【详细介绍】</a></td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td width="100%" height="217" valign="top"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="170" rowspan="2" align="center" class="di"><img
										src="New_images/indexl_010.gif" alt="" width="122" height="83" />
									</td>
									<td height="174" align="left" valign="top" class="news"><!-旅游攻略-->
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td height="47" colspan="3"><img
							src="New_images/index_80.png" width="1002" height="47" /></td>
					</tr>
					<tr>
						<td width="334" height="100">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td height="100" valign="top" class="fwzn">
										<!--游客须知-->
																...
																<table cellpadding="0" cellspacing="0" width="90%"
																	...
																	<tr>
																		<td align="left"><a
																			...
																			title="${ykxz.WZBT }"> ${ykxz.WZBT } </a></td>
						...
						<td width="334">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="120" height="100" align="center" valign="middle">
										<img src="New_images/index_86.png" width="103" height="81" />
									</td>
									<td height="100" valign="top" class="fwzn">
										<!--交通指南-->
